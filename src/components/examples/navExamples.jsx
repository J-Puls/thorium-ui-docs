...
export const variants = {
  link: (
    <Nav variant="link" justify="center" centerLinks trackActive>
  ...
  primary: (
    <Nav variant="primary" justify="center" centerLinks trackActive>
  ...
  secondary: (
    <Nav variant="secondary" justify="center" centerLinks trackActive>
  ...
  success: (
    <Nav variant="success" justify="center" centerLinks trackActive>
  ...
  warning: (
    <Nav variant="warning" justify="center" centerLinks trackActive>
  ...
  danger: (
    <Nav variant="danger" justify="center" centerLinks trackActive>
  ...
  light: (
    <Nav variant="light" justify="center" centerLinks trackActive>
  ...
  dark: (
    <Nav variant="dark" justify="center" centerLinks trackActive>
...
export const type = {
  ...
  tabs: (
    <Nav type="tabs" justify="center" variant="primary" centerLinks trackActive>
